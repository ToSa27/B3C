...
docker tag myhello:1 docker.die-hoffs.net/myhello:1
docker push docker.die-hoffs.net/myhello:1
docker build -t myhello:2 ~/B3C/docker2/
docker tag myhello:2 docker.die-hoffs.net/myhello:2
docker push docker.die-hoffs.net/myhello:2
